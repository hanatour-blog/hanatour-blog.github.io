...
<div>
  <img src="/assets/images/2022-06/shiry/happy-but-sad.jpg" alt="" />
...
그것이 그냥 커피라면, 클래스/메소드/변수 등의 진짜 이름을 정하는 것은 그야말로 TOP 라고 할 수 있습니다.
prefix, postfix 정하는 것이 대수인가요.
_"그래서 이 클래스는 뭐 하는 녀석인데?"_ 에 대한 고민에 비하면 아무것도 아닌 것을.

실제 코드 안에서 살아 숨쉬는 각종 이름들은, 그 클래스/메소드/변수 등등이 처한 상황에 따라
"어떤 적절한 단어를 선택 할 것인가" 에 대한 기준이 바뀌게 됩니다.
