...
당시에는 몰랐는데 근본적으로 손해보는 장사였다.

<div style="text-align:center;">
  <img src="/assets/images/2022-07/hoho/asset-40.png" alt="" style="max-width: 836px; width: 100%;" />
  <div style="font-size: 0.8em; margin-top: 12px;"><i>무지의 소치. 내 0.04원 어디갔어</i></div>
</div>
...
<br>
수개월간 밤잠 설쳐가며 고군분투 했지만 계속된 하락으로 -90%가 되었을때, 파랑새 따위 조용히 서랍장에 넣어두고 현실의 나를 열심히 살기로 했다.
